...
################
        self.main_display_frame=ttk.Frame(self.display_frame)
        self.main_display_frame.grid(row=1,column=0,rowspan=5,columnspan=2)
        ttk.Label(self.main_display_frame, text="General data:").grid(row=0,column=0,columnspan=2,pady=(10,0),sticky="sw")
        self.general_data_display = Text(self.main_display_frame, width=50, height=3,font=('Arial',8))
        self.general_data_display.grid(row=1,columnspan=2, padx=10, pady=5)
        ttk.Label(self.main_display_frame, text="Signal data:").grid(row=2,column=0,columnspan=2,pady=(10,0),sticky="sw")
        self.signal_data_display = Text(self.main_display_frame, width=50, height=3,font=('Arial',8))
        self.signal_data_display.grid(row=3,columnspan=2, padx=10, pady=5)
        ttk.Label(self.main_display_frame, text="Camera display").grid(row=4,column=0,pady=(10,0))
        ttk.Label(self.main_display_frame, text="Model trajectory").grid(row=4,column=1,pady=(10,0))
 ########################################   
